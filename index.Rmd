...
names(data) <- c("Fakultas", "Pendaftar","Lulus", "Ya", "Tidak", "Ya (%)", "Tidak (%)", "Diterima")
kable(data) %>%
  kable_styling(bootstrap_options = "striped", full_width = F,
                latex_options = "scale_down") %>%
...
names(data) <- c("Fakultas/Program Studi", "Pendaftar", "Lulus", "Ya", "Tidak", "Ya (%)", "Tidak (%)", "Diterima")
...
### Berikut adalah daftar nama calon mahasiswa baru Universitas Sultan Ageng Tirtayasa jalur SMMPTN 2020 yang melakukan registrasi di admisi.untirta.ac.id (**gunakan Search untuk pencarian cepat**)
...
### Berikut adalah daftar nama mahasiswa baru (**sudah mendapatkan NIM**) Universitas Sultan Ageng Tirtayasa jalur SMMPTN 2020 (**gunakan Search untuk pencarian cepat**)
