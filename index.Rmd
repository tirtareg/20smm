...
db <- read_excel("G:/My Drive/#PMB/2020/02_SBMPTN/Dashboard/20sbm/sbmptn.xlsx", sheet = "Sheet1")
...
names(data) <- c("Fakultas", "Peminat","Lulus", "Sudah", "Belum", "Sudah (%)", "Belum (%)", "Diterima")
kable(data) %>%
  kable_styling(bootstrap_options = "striped", full_width = F,
                latex_options = "scale_down") %>%
...
names(data) <- c("Fakultas/Program Studi", "Peminat","Lulus", "Sudah", "Belum", "Sudah (%)", "Belum (%)", "Diterima")
